...
| Package | Purpose |
|---------|---------|
| [`bluerobotics_parts`](https://github.com/HonuRobotics/bluerobotics_models/tree/lyrical/bluerobotics_parts) | the part library: one URDF xacro macro per part (`urdf/`), the meshes (`models/`), the assembly dispatcher and the review tools |
...
| `bluerobotics_parts/urdf/<part>.urdf.xacro` | by a person, maintained by hand | the part contract ([Parts](../design/parts.md)) |
