...
Gamepad teleoperation for the BlueROV2 and the BlueBoat: `joy_node`,
`teleop_twist_joy` and the `twist_to_thrust` mixer, with a calibration
walkthrough for new gamepads.
