...
"""
Generate every artifact of a BlueROV2 loadout from one config file.
...
vehicle be reconfigured without rebuilding, also from a binary install:
    ...
    ros2 launch bluerov2_gazebo sim.launch.xml config_file:=my_loadout.yaml   # does this for you
...
<model>
  ...
  <description>BlueROV2, generated by configure_vehicle.py from a loadout config.</description>
</model>
"""
